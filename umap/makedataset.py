...
files = glob.glob('/mnt/data3/schooldata/data/*.bson')
...
count = 0
allChannel = False
oneParticipant = False
for file in files:
    
    base = os.path.basename(file)
    participant = int(re.findall('[0-9]+',base)[0])
    #print(os.path.basename(file))
    outData,outParticipants,outChannel,outArousal,outValence,outDominance,outTrial,outTime = loadDeapFile(file,partcipantNumber=participant,allChannel=allChannel,fmin=0,fmax=140)
